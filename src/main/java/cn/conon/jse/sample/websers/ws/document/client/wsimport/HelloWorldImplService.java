 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.document.ws.websers.sample.jse.conon.cn/", wsdlLocation = "http://localhost:7779/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.document.ws.websers.sample.jse.conon.cn/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.document.ws.websers.sample.jse.conon.cn/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.document.ws.websers.sample.jse.conon.cn/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
