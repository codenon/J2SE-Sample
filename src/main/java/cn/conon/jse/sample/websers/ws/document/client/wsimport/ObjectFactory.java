...
package cn.conon.jse.sample.websers.ws.document.client.wsimport;
 ...
 * generated in the cn.conon.jse.sample.websers.ws.document.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://server.document.ws.websers.sample.jse.conon.cn/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://server.document.ws.websers.sample.jse.conon.cn/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.conon.jse.sample.websers.ws.document.client.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.document.ws.websers.sample.jse.conon.cn/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.document.ws.websers.sample.jse.conon.cn/", name = "getHelloWorldAsString")
