 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "www.conon.cn", wsdlLocation = "http://localhost:9999/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("www.conon.cn", "HelloService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("www.conon.cn", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("www.conon.cn", "HelloServicePort"), HelloService.class, features);
    }
